...
{
public:
    BoolVar( const std::string& path, bool val, bool inCanChange = true );
    BoolVar& operator=( bool val ) { if ( m_CanChange ) { m_Flag = val; } return *this; }
    operator bool() const { return m_Flag; }

    virtual void Increment( void ) override { if ( m_CanChange ) { m_Flag = true; } }
    virtual void Decrement( void ) override { if ( m_CanChange ) { m_Flag = false; } }
    virtual void Bang( void ) override { if ( m_CanChange ) { m_Flag = !m_Flag; } }
    ...
    void SetCanChange( bool inCanChange ) { m_CanChange = inCanChange; }

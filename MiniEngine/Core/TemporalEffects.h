...
namespace TemporalEffects
{
    ...
    extern uint32_t TAAEnabledStatus;   // 0 - disabled, 1 - MSFT's, 2 - Intel's
    ...
    void ResolveImage(CommandContext& Context, const Math::Matrix4& CurrentProjectionMatrix, const Math::Matrix4& PrevProjectionMatrix );
